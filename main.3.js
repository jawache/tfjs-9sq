...
function createModel() {
  ...
  function predict(x) {
    // We want it to return a label tensor like this -> [0, 1, 0, 0, 0, 1, 0, 1, 0, 0]
    return x
      .mul(weights)
      .sum((axis = 1))
      .step(0);
  ...
  function loss(predicted, actual) {
    ...
    // Sum up the difference between the input and output labels
...
//  *
//  * 1. Load file, parse into data points.
//  * 9 data pointd, x1,x2,x3.... variables
//  *
//  * 2. Loss function multiply each value by weights - [1,1,1]
//  *
//  *
//  *
//  *
